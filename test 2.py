...
# Scatter plot
scat = ax.scatter([], [], s=size, lw=0.5, edgecolors=color, facecolors='None')
scat1 = ax.scatter([], [], s=size, lw=1.0, edgecolors=color, facecolors='None', marker='^')
...
def update(frame):
    ...
    scat1.set_edgecolors(color)
    scat1.set_sizes(size)
